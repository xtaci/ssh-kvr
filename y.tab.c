...
{
      31,     0,    -1,    -1,    31,    32,    -1,    33,     3,    -1,
      34,     3,    -1,    35,     3,    -1,    36,     3,    -1,     3,
      -1,     1,     3,    -1,     5,     6,    -1,     5,    10,    -1,
       5,     9,    -1,     5,    12,    -1,     5,    -1,     6,     7,
      -1,     6,     8,    -1,     6,    -1,     9,     8,    -1,     9,
      -1,    15,    16,     8,    -1,    15,     1,    -1
};
...
{
  "$end", "error", "$undefined", "EOL", "NUMBER", "HELP", "SHOW", "ALL",
  "IP", "GOTO", "CREATE", "DELETE", "NODE", "FILENAME", "LOADKEY",
  "NODEDEFINE", "EQ", "NE", "LT", "LE", "GT", "GE", "PLUS", "MINUS",
  "MULT", "DIVIDE", "RPAREN", "LPAREN", "ASSIGN", "SEMICOLON", "$accept",
  "commands", "command", "help", "show", "goto", "node_define", YY_NULL
};
#endif
...
{
       2,     0,     1,     0,     8,    14,    17,    19,     0,     3,
       0,     0,     0,     0,     9,    10,    12,    11,    13,    15,
      16,    18,    21,     0,     4,     5,     6,     7,    20
};
...
{
      -3,     0,    -3,    10,    -3,    -2,     4,     6,     1,    -3,
      13,    15,    16,    17,    -3,    -3,    -3,    -3,    -3,    -3,
      -3,    -3,    -3,    14,    -3,    -3,    -3,    -3,    -3
};
...
{
       2,     3,    22,     4,    15,     5,     6,    16,    17,     7,
      18,    19,    20,    14,    21,     8,    24,    23,    25,    26,
      27,     0,    28
};
...
{
       0,     1,     1,     3,     6,     5,     6,     9,    10,     9,
      12,     7,     8,     3,     8,    15,     3,    16,     3,     3,
       3,    -1,     8
};
...
{
       0,    31,     0,     1,     3,     5,     6,     9,    15,    32,
      33,    34,    35,    36,     3,     6,     9,    10,    12,     7,
       8,     8,     1,    16,     3,     3,     3,     3,     8
};
